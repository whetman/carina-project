...
public class MobileUserActionsTests extends AbstractTest {
    ...
    public void validateSignUp(AccountInformation accountInfo) {
        ...
        SignupPageBase signupPage = new com.solvd.gui.pages.mobile.SignupPage(getDriver());

        if (signupPage.getEmailAlreadyExistsMessage().isDisplayed() && signupPage.getEmailAlreadyExistsMessage().getText().contains("exists")) {
